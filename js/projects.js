 ...
 *                                        ↑ copy this part
 * 3.  Drop your thumbnail image (.png / .jpg) into assets/images/
 * 4.  Copy one of the objects below and paste it inside the
 *     PROJECTS array. Fill in your fields and save.
 * 5.  Reload index.html — your card appears automatically!
 *
 * FIELD REFERENCE:
 * ─────────────────
 ...
 *  youtubeId    (string|null)   – YouTube video ID only (not the full URL).
 *                                 e.g. "dQw4w9WgXcQ"
 *                                 Set to null if no video.
 *  imagePath    (string|null)   – Thumbnail / screenshot path.
 *                                 Used as the card preview image.
...
window.PROJECTS = [
  ...
  /* ── Project 1 ────────────────────────────────────────── */
  {
    ...
    year:        2025,
    youtubeId:   "f7tEHGyEOcM",             // ← paste your YouTube video ID here e.g. "dQw4w9WgXcQ"
    imagePath:   "assets/images/BridgSign.png",
    tags:        ["unity"],
   // links: [
   //   { label: "Play on itch.io",  href: "https://yourname.itch.io/bridgsign", icon: "&#127918;" },
   //   { label: "Source on GitHub", href: "https://github.com/yourhandle/bridgsign", icon: "&#128279;" }
   // ]
  },
  ...
  /* ── Project 2 ────────────────────────────────────────── */
  {
    ...
    year:        2025,
    youtubeId:   "AhZRzsIBJNQ",             // ← paste your YouTube video ID here
  ...
  /* ── Project 3 ────────────────────────────────────────── */
  {
    ...
    year:        2024,
    youtubeId:   "6xaTqke2UcE",             // ← paste your YouTube video ID here
  ...
  ,{
    ...
    description: "My Capstone Project. " +
                 ...
                 "No Extra Hardware",
    year:        2024,
    youtubeId:   "7OVVKeDQ4I0",             // ← paste your YouTube video ID here
    imagePath:   "assets/images/Trailer.png",
    tags:        ["unity"],
    links: [
     // { label: "Watch trailer", href: "https://youtube.com/", icon: "&#127909;" },
     // { label: "Download",      href: "https://drive.google.com/...", icon: "&#9654;" }
    ]
  }
  ...
  ,{
    ...
    description: "A Tower Defense game built in Unity. " +
                 ...
                 "I need a big Laugh",
    year:        2023,
    youtubeId:   "ES7OlSbNby8",             // ← paste your YouTube video ID here
  ...
  ,{
    ...
    description: "Keskayoun was our school project, and it was the first game we developed. " +
                 ...
                 "the game contains multiple Avatars, abilities and maps. " +
                 "Team VS Team Game. " +
                 "Game Of the Year In ESPRIT SCHOOL",
    year:        2023,
    youtubeId:   "he1sVRpOzWU",             // ← paste your YouTube video ID here
